...
// demo_live/ = demo/ rewired for static hosting (generated by
// scripts/sync-demo-live.mjs): pinned CDN import map + stylesheet, relative
...
assert.ok(
  liveIndex.includes(`anim-kit@${payload.version}/dist/index.js`) &&
    liveIndex.includes(`anim-kit@${payload.version}/dist/styles/anim-kit.css`),
